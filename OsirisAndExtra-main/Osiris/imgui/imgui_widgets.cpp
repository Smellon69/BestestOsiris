...
bool ImGui::tab(const char* icon, bool selected)
{
    ...
    GetWindowDrawList()->AddRectFilled(ImVec2(bb.Min.x, bb.Min.y), ImVec2(bb.Max.x, bb.Max.y), ImColor(33, 33, 33, int(255 * GetStyle().Alpha)), 5);
    GetWindowDrawList()->AddRect(ImVec2(bb.Min.x, bb.Min.y), ImVec2(bb.Max.x, bb.Max.y), ImColor(37, 37, 37, int(255 * GetStyle().Alpha)), ImDrawFlags_RoundCornersBottomRight, 15, 2.2);

    GetWindowDrawList()->AddText(ImVec2(bb.Min.x + 7, bb.Min.y + 6.3), ImColor(65, 65, 65, int(255 * GetStyle().Alpha)), icon);

    if (selected)
    {
        //line
        GetWindowDrawList()->AddRectFilled(ImVec2(pos.x - 15, pos.y + 10), ImVec2(pos.x - 11, pos.y + 30), ImColor(94, 159, 255, int(255 * it_filled->second)), ImDrawFlags_RoundCornersBottomRight, 10);
        GetWindowDrawList()->AddText(ImVec2(bb.Min.x + 7, bb.Min.y + 6.3), ImColor(94, 159, 255, int(255 * it_filled->second)), icon);
    }
...
bool ImGui::beginchildex(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags)
{
    ...
    parent_window->DrawList->AddRectFilled(pos, p + size_arg, ImColor(25, 25, 25, int(255 * alpha)), 5);
    parent_window->DrawList->AddRect(pos, p + size_arg, ImColor(37, 37, 37, int(255 * GetStyle().Alpha)), ImDrawFlags_RoundCornersBottomRight, 15, 2.2);

    //ImGui::PushFont(LexendDecaFont);
    parent_window->DrawList->AddText(pos + ImVec2(10, 8), ImColor(65, 65, 65, int(255 * alpha)), name);

    parent_window->DrawList->AddRectFilled(pos + ImVec2(10, 33), pos + ImVec2(79, 35.2), ImColor(35, 35, 35, int(255 * alpha)), 5);
    //ImGui::PopFont();
